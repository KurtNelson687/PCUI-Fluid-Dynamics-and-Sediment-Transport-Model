...
working_folder = '/usr/var/tmp/barthur/1199316';
save_file = 'energy';
...
save(save_file,'t','tdt','tn','Et','Ek','Ep','Eb','Ea', ...
               'dEtdt','dEkdt','dEpdt','dEbdt','dEadt', ...
               'phi_d','phi_d_eff','phi_z','phi_i', ...
               'eps_top','eps_int','eps_low','eps_bot','eps_tot');
display('Complete');
