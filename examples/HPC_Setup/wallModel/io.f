cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	do while(ios == 0)
	  ...
	  if (ios == 0) then
	    ...
	    case ('ised')
	      ...
	      write(*,*) 'ised  = ', ised
	    case ('wallModel')
	      read(buffer, *, iostat=ios) wallModel
	      write(*,*) 'wallModel  = ', wallModel
	    case ('waves')
	    ...
	    case ('g')
	      ...
	      write(*,*) 'g  = ', g
	    case ('uTarget')
	      read(buffer, *, iostat=ios) uTarget
	      write(*,*) 'uTarget = ', uTarget
	    case ('dpdxSteady')
	...
	call MPI_BCAST(g,           1,MPI_DOUBLE_PRECISION,0,
     <                              MPI_COMM_WORLD,ierr)
	call MPI_BCAST(uTarget,  1,MPI_DOUBLE_PRECISION,0,
     <                              MPI_COMM_WORLD,ierr)
