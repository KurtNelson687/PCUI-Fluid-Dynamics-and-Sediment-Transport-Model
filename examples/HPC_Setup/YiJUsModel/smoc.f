...
CCC	if ( res_new .lt. tol(level) .and. erabs .lt. ter(level) ) then
CCC	IF ( MOD(ISTEP,NSAVE) .EQ. 0 .and. MYID .EQ. 0 ) 
CCC  <	WRITE(*,2) LEVEL, N, RESID, RESID/BBSUM, ERMIN, ERMAX, 
CCC  <	                     RESBC, RESBC/SUMBC
CCC 2	FORMAT(' L', I1, ' #', I2, ' CONVERGED ', 2E9.3, 
CCC  <	       ' E', 2E9.3, ' BC', 2E9.3)
CCC	return
CCC	endif
