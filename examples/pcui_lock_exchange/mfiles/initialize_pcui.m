...
working_folder = '/home/barthur/pcui-3d/examples/pcui_lock_exchange';
...
% -------------------------------------------------------------------------
% Initialize PCUI with a lock exchange
% -------------------------------------------------------------------------
% Prepare density field
D = params.by;
rho_init_pcui = ones(size(x));
rho_pert_pcui = 0.015*rho_init_pcui;
rho_pert_pcui(x>2) = -0.015; 
