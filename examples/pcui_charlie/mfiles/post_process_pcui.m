...
set(fig1,'Position',[200 200 800 800]);
...
if movie
    imwrite(im,map,'/home/barthur/pcui-3d/examples/pcui_charlie/mfiles/coarse_movie_no_wave.gif','DelayTime',0.1,'LoopCount',inf);
end
